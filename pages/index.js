  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="/PngItem_4219473.png" />
      ...
      {/* ====baha`i`-writings==== */}
      <div id='teachings' className='bg-blue-50 px-8 lg:px-24 xl:px-44 py-12'
        style={{
      ...
      {/* ===bahai-prayers=== */}
      <div id='prayers' className='bg-blue-50 px-8 lg:px-24 xl:px-44 py-12'
        style={{
